...
// Last updated: 2025-10-07 10:47:36
...
export const API_CONFIG = {
  ...
  BACKEND_URLS: [
    'https://ce6ed256283d.ngrok-free.app',
    'http://100.69.2.137:8000',
    'http://localhost:8000',
    'http://10.0.2.2:8000'
  ],
  
  // Current ngrok URL (null if not available)
  NGROK_URL: 'https://ce6ed256283d.ngrok-free.app',
  
  // Local network IP
  LOCAL_IP: '100.69.2.137',
  LOCAL_PORT: 8000,
